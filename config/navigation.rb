...
SimpleNavigation::Configuration.run do |navigation|
  ...
  #sub_nav.item :virk, 'Virksomheder', virk_path, 
  #  :link => {:style => 'font-weight:bolder;', :class => 'submini'} do |virknavn|
  #sub_nav.item :virk, 'Virksomheder', virk_path do |virknavn|
   
   #             virknavn.item :virksom, @virksomhed.try(:name), 
   #             url_for(@virksomhed), :highlights_on => /virksomheder\/[0-9]+/
  #end
